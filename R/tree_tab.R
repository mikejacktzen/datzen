...
#' The tree_tab() function to conveniently tabulate hierarchical counts
#'
#' @param formula_tab a formula
#' @param dat_in a dataframe of columns usable by formula
#'
#' @return a list of tables and a tree
#' @export
#'
#' @examples
#' names(starwars)
...
# (mass|3) +  # if (var_numeric|cut_numeric) then cutpoint
